...
CREATE TABLE IF NOT EXISTS system__ship_groups(
    id UUID PRIMARY KEY,
    owner_id UUID NOT NULL,
    category VARCHAR(25) NOT NULL,
    quantity INT NOT NULL
...
ALTER TABLE system__ship_groups ADD CONSTRAINT system_fkey FOREIGN KEY (owner_id) REFERENCES map__systems (id) ON DELETE CASCADE;
ALTER TABLE fleet__ship_groups ADD CONSTRAINT fleet_fkey FOREIGN KEY (owner_id) REFERENCES fleet__fleets (id) ON DELETE CASCADE;
